...
# %%
# import functions
from utils.AlpacaFunctions import get_crypto_bars, get_news
...
def get_crypto_model(ticker, numDays, initial_capital):
    ...
    stock_df = get_crypto_bars(symbol=ticker, timeframe=timeframe, start=start, end=end, limit=limit)
